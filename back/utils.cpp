...
std::vector<std::string> recursive_character_text_splitter(const std::string& text, size_back_t chunk_size, size_t chunk_overlap) {
...
void kmeans_cuda(const std::vector<float>& h_embeddings, int num_embeddings, int dim, int k, std::vector<int>& h_labels) {
