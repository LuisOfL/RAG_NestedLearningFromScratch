...
# 1. Cargamos el entorno desde el archivo .env antes de inicializar los clientes
load_dotenv()
...
# ==========================================
# 1. Credenciales de Azure Blob Storage
AZURE_STORAGE_CONNECTION_STRING = os.getenv("AZURE_STORAGE_CONNECTION_STRING")
CONTAINER_NAME = "pdf"
BLOB_NAME = "7245fcea1c7bf0a995952dabe3da456d.pdf"  # Asegúrate de que coincida con el portal
